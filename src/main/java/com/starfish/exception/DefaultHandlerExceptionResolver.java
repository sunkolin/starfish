...
//            log.error("exception occur.url is {},description is {},code is {},message is {}", url, checkedException.getDescription(), checkedException.getCode(), checkedException.getMessage(), ex);
//            return newInstance(checkedException.getCode(), checkedException.getMessage(), checkedException.getDescription());
//        }
//
//        if (ex instanceof CustomException) {
//            CustomException customException = (CustomException) ex;
//            log.error("exception occur.url is {},description is {},code is {},message is {}", url, customException.getDescription(), customException.getCode(), customException.getMessage(), ex);
//            return newInstance(customException.getCode(), customException.getMessage(), customException.getDescription());
//        }
//        log.error("system exception occur.url is {}", url, ex);
//
