...
/**
 * PushDeer PushDeer已停止更新，建议使用Bark <a href="https://www.pushdeer.com/official.html">参考文档1</a>
...
public class PushDeerPushService implements Push {
    ...
    public Result<Object> push(PushDeerRequest param) {
        ...
        ResponseEntity<String> responseEntity =
                RestTemplates.exchange(url, HttpMethod.POST, null, params, null, String.class);
