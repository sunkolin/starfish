...
//        ResponseEntity<String> response = RestTemplatePlus.exchangeSkipSsl(url, method, headers, params, null, responseType);
...
//
//        // 格式如下{"rs":1,"code":0,"address":"中国  北京 北京市 电信","ip":"106.120.64.78","isDomain":0}
