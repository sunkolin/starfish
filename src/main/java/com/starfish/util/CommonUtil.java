...
public final class CommonUtil {
    ...
    public static String getPublicAddress() {
        ...
        ResponseEntity<String> result = RestTemplatePlus.exchange("https://ip.cn/api/index?ip=&type=0", HttpMethod.GET, headers, null, null, String.class);
        ...
        String json = res.substring(res.indexOf("{"), res.indexOf("}") + 1);
